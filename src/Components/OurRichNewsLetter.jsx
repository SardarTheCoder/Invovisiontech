export const OurRichNewsLetter = () => {
  return (
    <>
      <div className="w-full ">
        <div className="max-w-[1280] px-6 mx-auto">
          <div className="text-center mt-10">
            <h1 className="lg:text-5xl  text-2xl py-10 font-bold ">
          ...
          <div className="flex justify-center  ">
            ...
            <button className="my-16   lg:text-xl text-sm h-14 py-3 text-white px-6 md:px-10   bg-gradient-to-r  from-cyan-200 to-blue-500 hover:bg-gradient-to-l md:px-4 md:py-4  ">
              Get Started
            </button>
          </div>
        </div>
